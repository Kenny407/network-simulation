...
proc finish {} {
  global ns out out2 R b lossRate dynamicN tokenRate
  puts "$R $lossRate"
  #puts $out2 "$dynamicN $lossRate"
  $ns flush-trace
  close $out
  close $out2
  exit 0
...
$poissonTraffic set burst_time_ $Ton;
...
proc tokenGenerator { } {
  ...
  # call itself for each interval of 1/R (tokenRater) later
...
$ns at $tokenRate "tokenGenerator"; # start the token generator
